    ...
    <div className="space-y-24 py-12">
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="p-8 space-y-4 text-center border-2 hover:border-primary/50 transition-colors">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-3xl p-12 md:p-16 text-center space-y-8">
        <div className="space-y-4">
