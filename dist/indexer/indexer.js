...
export class FairSwapIndexer {
    ...
    async processTransaction(signature, slot) {
        ...
        const instructions = message.compiledInstructions.filter((ix) => {
        ...
        for (const instruction of instructions) {
            try {
                ...
                const instructionAccountKeys = instruction.accountKeyIndexes.map((index) => accountKeys[index].toBase58());
